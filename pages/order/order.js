Page({
  ...
  toBuy: function(e){
    ...
    var prepay_id = e.currentTarget.dataset.id;
    var timeStamp = Math.floor(new Date().getTime() / 1000) + '';
    console.log("timeStamp = " + timeStamp);
    var nonceStr = this.randomString(32, '#aA');
    ...
    var paySign = this.MD5(stringB).toUpperCase();  
